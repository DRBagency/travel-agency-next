  ...
  return (
    <footer className="relative border-t border-white/10 bg-slate-950">
      ...
      <div
        ...
        style={
          primaryColor
            ? { ["--accent" as any]: primaryColor }
            : { ["--accent" as any]: "#38bdf8" }
        }
      >
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              {instagramUrl && (
                ...
                >
                  <svg
                    className="w-5 h-5 text-white/60 group-hover:text-[color:var(--accent)] transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Destinos", "Opiniones", "Nosotros", "Contacto"].map((item) => (
                <li key={item}>
                  <a
                    href={`#${item.toLowerCase()}`}
                    className="text-white/60 hover:text-[color:var(--accent)] transition-colors"
                  >
                    {item}
                  </a>
                </li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/50 text-sm">
            © {currentYear} ViajesEspaña. Todos los derechos reservados.
          </p>
          <p className="text-white/50 text-sm">
            Licencia de Agencia de Viajes: CICMA-1234
          </p>
        </div>
      </div>
    </footer>
