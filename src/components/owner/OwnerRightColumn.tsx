...
export default function OwnerRightColumn({
  ...
  return (
    <div className="relative flex flex-col h-full overflow-hidden">
      {/* Profile card — glass over DashboardBackground */}
      <div className="relative mx-3 mt-3 rounded-2xl panel-card p-4">
      ...
      <div className="flex-1 min-h-0 flex flex-col mx-3 mt-2.5 mb-3 rounded-2xl panel-card overflow-hidden">
