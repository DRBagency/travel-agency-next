    ...
    >
      <div className="flex items-center justify-between px-3 pt-2.5 pb-1.5">
        <div className="flex items-center gap-1.5">
          <div className="w-5 h-5 rounded-lg bg-gradient-to-br from-drb-turquoise-500 to-drb-turquoise-600 flex items-center justify-center">
        ...
        <a href="/admin/reservas" className="text-[11px] font-medium text-drb-turquoise-600 dark:text-drb-turquoise-400 hover:text-drb-turquoise-700 transition-colors">
          {labels.viewAll}
        </a>
      </div>
      <div className="px-3 pb-2.5">
        {bookings.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-4 text-center">
            <Plane className="w-6 h-6 text-drb-turquoise-300 dark:text-drb-turquoise-600 mb-1" />
            <p className="text-xs text-gray-400 dark:text-white/40">{labels.noBookingsYet}</p>
          </div>
        ) : (
          <div ref={animateRef} className="space-y-1">
                ...
                >
                  {r.id ? (
                    <Link
                      ...
                      className="flex items-center justify-between rounded-lg bg-gray-50 dark:bg-white/[0.03] border border-gray-100 dark:border-white/[0.06] px-2.5 py-2 hover:bg-drb-turquoise-50/50 dark:hover:bg-white/[0.05] transition-colors cursor-pointer"
                    >
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-7 h-7 rounded-full bg-gradient-to-br ${gradient} flex items-center justify-center text-white text-xs font-semibold shadow-sm`}
                        >
                          {initial}
                        </div>
                        <div>
                          <div className="font-medium text-xs text-gray-900 dark:text-white hover:text-drb-turquoise-600 dark:hover:text-drb-turquoise-400 transition-colors">
                    ...
                    <div className="flex items-center justify-between rounded-lg bg-gray-50 dark:bg-white/[0.03] border border-gray-100 dark:border-white/[0.06] px-2.5 py-2">
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-7 h-7 rounded-full bg-gradient-to-br ${gradient} flex items-center justify-center text-white text-xs font-semibold shadow-sm`}
                        >
