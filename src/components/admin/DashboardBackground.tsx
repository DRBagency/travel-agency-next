  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <div
        ...
        style={{
          background: isLight
            ? 'radial-gradient(ellipse 120% 80% at 50% 100%, #D8E2EE, #EFF3F8 70%)'
      ...
      <div
        ...
        style={{
          ...
          background: `radial-gradient(circle, rgba(28,171,176,${isLight ? 0.22 : 0.65}), transparent 70%)`,
          filter: 'blur(120px)',
        }}
      />
      <div
        ...
        style={{
          ...
          background: `radial-gradient(circle, rgba(212,242,77,${isLight ? 0.14 : 0.45}), transparent 70%)`,
          filter: 'blur(110px)',
        }}
      />
      <div
        ...
        style={{
          ...
          background: `radial-gradient(circle, rgba(28,171,176,${isLight ? 0.18 : 0.50}), transparent 70%)`,
          filter: 'blur(120px)',
        }}
      />
      <div
