...
function TestimonialCard({
  ...
  return (
    <CursorGlow color={`color-mix(in srgb, ${accentColor} 12%, transparent)`}>
      <div className="flex-shrink-0 w-[380px] md:w-[420px] bg-white/60 backdrop-blur-lg p-7 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 group border border-white/40">
