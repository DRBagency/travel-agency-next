  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-white dark:bg-[#041820] border border-gray-200 dark:border-white/10 rounded-2xl w-full max-w-3xl max-h-[80vh] flex flex-col shadow-2xl mx-4">
        {/* Header */}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {photos.map((photo) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 start-0 end-0 p-2 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
