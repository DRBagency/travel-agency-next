...
async function createDestino(formData: FormData) {
  ...
  const payload: Record<string, any> = {
    ...
    moneda: (formData.get("moneda") as string) || "EUR",
    reviews: Number(formData.get("reviews") || 0) || 0,
    ...
    galeria: safeJsonParse(formData.get("galeria") as string | null),
    salidas: safeJsonParse(formData.get("salidas") as string | null),
