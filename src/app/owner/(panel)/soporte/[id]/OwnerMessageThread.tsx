...
export default function OwnerMessageThread({
  ...
  ticketStatus,
  addMessageAction,
}: OwnerMessageThreadProps) {
  const t = useTranslations("owner.soporte.thread");
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4 min-h-[300px] max-h-[500px]">
        {messages.map((msg) => {
          ...
          // For owner view: admin messages are "ours" (right), client messages are "theirs" (left)
          const isOwner = msg.sender_type === "admin";
          ...
          return (
            ...
            >
              ...
              >
                ...
                <p
                  className={`text-[10px] mt-1.5 ${
                    isOwner ? "text-white/50" : "text-gray-400 dark:text-white/25"
                  }`}
                >
              ...
              {/* Avatar (right for owner/support) */}
              {isOwner && (
