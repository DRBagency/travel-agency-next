...
import { updateClientNotes, updateLeadStatus, createActivity } from "../../crm/actions";
...
export default function CRMTab({ clientId, notes, leadStatus, activities }: CRMTabProps) {
  ...
  const handleSaveNotes = () => {
    startTransition(async () => {
      await updateClientNotes(clientId, currentNotes);
      setNotesSaved(true);
  ...
  const handleStatusChange = (newStatus: string) => {
    startTransition(() => {
      updateLeadStatus(clientId, newStatus);
    });
  };
  ...
  const handleAddActivity = () => {
    ...
    startTransition(async () => {
      await createActivity(clientId, actType, actContent);
      setActContent("");
    });
  };
